...
# 2) Terminal: cd PYTHON/GeminiImg2Code > pip install -r requirements.txt

# 3) Terminal: cd PYTHON/GeminiImg2Code > streamlit run app.py
...
#---------------------------------------------
#API_KEY = 'AIzaSyCrQ6d2K0taElhVO8zP7tywQrdMLKdinFE'
...
#--------------------------------
def main():
    st.set_page_config(page_title="EC-IT Tool", page_icon="images/EC-IT-LOGO-1.png", layout="centered")
    st.title("Gemini IMG to Code 💾 ")
    st.subheader('Developed by [D.Paz](#)')
