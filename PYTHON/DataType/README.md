...
<a href=".\images\ec-it-tools-1.gif"><img src=".\images\ec-it-tools-1.gif" style="height: 80%; width:80%;"/></a>
...
<a href=".\images\ec-it-tools-2.gif"><img src=".\images\ec-it-tools-2.gif" style="height: 80%; width:80%;"/></a>

## Conversor a Binario:

Transforma el texto ingresado en su representación binaria (secuencia de ceros y unos).
<a href=".\images\ec-it-tools-3.gif"><img src=".\images\ec-it-tools-3.gif" style="height: 80%; width:80%;"/></a>
...
<a href=".\images\ec-it-tools-4.gif"><img src=".\images\ec-it-tools-4.gif" style="height: 80%; width:80%;"/></a>

## Traductor a Braille:

Traduce texto en minúsculas al sistema de escritura Braille, utilizado por personas con discapacidad visual.
<a href=".\images\ec-it-tools-5.gif"><img src=".\images\ec-it-tools-5.gif" style="height: 80%; width:80%;"/></a>

## Generador de Password:

Crea contraseñas seguras de longitud variable, incluyendo letras mayúsculas, minúsculas, números y símbolos.
<a href=".\images\ec-it-tools-6.gif"><img src=".\images\ec-it-tools-6.gif" style="height: 80%; width:80%;"/></a>

## Acortador de URL:

Reduce la longitud de una dirección web (URL) proporcionada, facilitando su uso y compartición.
<a href=".\images\ec-it-tools-7.gif"><img src=".\images\ec-it-tools-7.gif" style="height: 80%; width:80%;"/></a>
...
<a href=".\images\ec-it-tools-8.gif"><img src=".\images\ec-it-tools-8.gif" style="height: 80%; width:80%;"/></a>
...
<a href=".\images\ec-it-tools-9.gif"><img src=".\images\ec-it-tools-9.gif" style="height: 80%; width:80%;"/></a>
...
<a href=".\images\ec-it-tools-10.gif"><img src=".\images\ec-it-tools-10.gif" style="height: 80%; width:80%;"/></a>
